...
def on_connect(client, userdata, flags, rc):
    ...
    client.subscribe("sarandi/ipinfo")
    client.subscribe("currentdate") #subscribes to subtopic "currentdate"
    client.subscribe("currenttime") #subscribes to subtopic "currenttime"
    
    #Add the custom callbacks by indicating the topic and the name of the callback handle
    client.message_callback_add("sarandi/ipinfo", on_message_from_ipinfo)

    client.message_callback_add("currentdate", on_message_from_time)

    client.message_callback_add("currenttime", on_message_from_date)
